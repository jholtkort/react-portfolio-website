      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-10 home-text">
            ...
            <h5 className="my-3">
              I am a software developer based out of Austin, TX, and am
              passionate about making responsive software and web applications
              that solve clients' biggest challenges.
            </h5>
            <div className="icons">
